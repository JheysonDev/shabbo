...
class HoverContainer extends Container {
    ...
    constructor(private gameApplication: Application, text: string, private options?: HoverTextProps) {
        super();
    ...
    private _onMouseOver(e: any) {
        ...
        this.gameApplication.stage.addChild(this.hover);
    ...
    private _onMouseOut() {
        this.gameApplication.stage.removeChild(this.hover)
    }
}
